...
def create_razorpay_order(request, order_id):
    ...
    try:
        ...
        return render(request, "payments/failure.html", {"error": "Network error: Unable to connect to Razorpay. Please check your internet connection."})
    except razorpay.errors.RazorpayError as e:
        return render(request, "payments/failure.html", {"error": f"Razorpay Error: {str(e)}"})
    except Exception as e:
        return render(request, "payments/failure.html", {"error": "An unexpected error occurred while initiating payment."})
